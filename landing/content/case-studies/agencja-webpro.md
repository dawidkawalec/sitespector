...
key_metrics:
  ...
  - label: "Specjaliści w jednym panelu"
    before: "Każdy osobno"
    after: "3 w jednym workspace"
cover_image:
  src: "/images/case-studies/webpro-cover.png"
  alt: "Agencja WebPro — case study SiteSpector"
  placeholder: "PLACEHOLDER: Screenshot dashboardu agencji z wieloma workspace'ami klientów — 1200x630px"
logo:
  src: "/images/case-studies/webpro-logo.png"
  placeholder: "PLACEHOLDER: Logo Agencji WebPro — 200x100px"
testimonial:
  quote: "SiteSpector zastąpił nam trzy osobne narzędzia. Audyt techniczny, Lighthouse i rekomendacje AI – wszystko w jednym panelu."
  author: "Marek W."
  role: "SEO Manager, Agencja WebPro"
---
...
- 3 specjalistów z dostępem do jednego panelu (role: Owner, Admin, Member)
