 ...
 * 
 * Displays security metrics, SSL status, and mixed content alerts.
 */
...
import { Loader2, Shield, Lock, Unlock, AlertTriangle, CheckCircle2, ShieldAlert, ShieldCheck } from 'lucide-react'
...
export default function SecurityPage({ params }: { params: { id: string } }) {
  ...
  if (!security) {
    return (
      <div className="container mx-auto py-8 px-4">
        <p className="text-muted-foreground">Brak danych o bezpieczeństwie. Uruchom nowy audyt, aby przeprowadzić analizę security.</p>
      </div>
    )
  }
