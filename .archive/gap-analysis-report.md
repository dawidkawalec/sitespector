...
Dodatkowy hardening (2026-03-08, tura 3): dodano warstwe operacyjna UX (status + szybkie akcje rerun AI context/plan) na `ai-readiness` i `architecture` oraz sekcje `Ustawienia audytu` (`crawl-data`, `debug`) w sidebarze.
